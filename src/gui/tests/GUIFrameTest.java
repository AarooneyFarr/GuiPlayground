...
public class GUIFrameTest
{
	...
	private GuiFirstFrame testFrame;
	private GuiFirstPanel testPanel;
	...
	public void setUp() throws Exception
	{
		...
		testFrame = new GuiFirstFrame(testController);
		testPanel = new GuiFirstPanel(testController);
	}
	...
	{
		assertTrue(testFrame.getContentPane() instanceof GuiFirstPanel);
